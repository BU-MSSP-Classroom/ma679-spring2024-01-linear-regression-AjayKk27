...
ames_raw_2008<- ames_raw_2008 |> mutate(square_ft = `1st Flr SF`+`2nd Flr SF`,
                                        qual =`Overall Qual`^1.7 )

fit1<- lm(SalePrice~qual+Neighborhood+square_ft, data=ames_raw_2008)

```


```{r,eval=FALSE,echo=show_code}
lmfit_2008<- lm(SalePrice~qual+Neighborhood+square_ft, data=ames_raw_2008)# ["your model here"] # use #ames_raw_2008
```
...
ames_raw_2009<- ames_raw_2009 |> mutate(square_ft = `1st Flr SF`+`2nd Flr SF`,
                                        qual =`Overall Qual`^1.7 )
