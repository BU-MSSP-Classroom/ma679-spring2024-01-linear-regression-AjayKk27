...
```{r}
#One thing I looked at while doing EDA, because the data coincides with the 2008 financial crisis was why housing prices didn't seem to change much over the years at all. What did change was the number of houses sold. Potentially the number of houses sold would be a good variable to include as a 
